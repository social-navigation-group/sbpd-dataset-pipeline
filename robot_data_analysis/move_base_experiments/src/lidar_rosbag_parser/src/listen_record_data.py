...
class ListenRecordData:
    ...
    def callback(self, lidar, odom):
        ...
        # display the stuff
        # print(f"------------------------------------------------{self.viz_lidar}------------------------------------------------")
        if self.viz_lidar == "true":
            print("DISPLAYING BEV LIDAR IMAGE")
    ...
    def path_callback(self, msg):
        ...
        if self.start_time is not None:
            ...
            #print("Received move base path at time: ", msg.header.stamp.to_sec())
            #print("Start time: ", self.start_time)
            self.move_base_path_time = msg.header.stamp.to_sec() - self.start_time
            #print("RECIEVED MOVE BASE PATH AT TIME: ", self.move_base_path_time)
